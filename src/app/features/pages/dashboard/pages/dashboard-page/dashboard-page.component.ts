...
import { RecentSalesComponent } from '@/features/pages/dashboard/components/recent-sales/recent-sales.component';
import { StockAlertComponent } from '@/features/pages/dashboard/components/stock-alert/stock-alert.component';
import { ReportService } from '@/services/report.service';
import { AuthService } from '@/services/auth.service';
import { AdminMetricsViewComponent } from '@/features/pages/dashboard/components/app-admin-metrics-view/app-admin-metrics-view.component';
import { BranchStaffKpisComponent } from '@/features/pages/dashboard/components/branch-staff-kpis/branch-staff-kpis.component';
